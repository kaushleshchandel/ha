...
void setup() {
  ...
  rotary_encoder_rotaryencodersensor->set_name("Rotary Encoder");
  ...
  mqtt_mqttsensorcomponent = new mqtt::MQTTSensorComponent(rotary_encoder_rotaryencodersensor);
  ...
  rotary_encoder_rotaryencodersensor->set_pin_a(new GPIOPin(14, INPUT, false));
  rotary_encoder_rotaryencodersensor->set_pin_b(new GPIOPin(12, INPUT, false));
  rotary_encoder_rotaryencodersensor->set_resolution(rotary_encoder::ROTARY_ENCODER_1_PULSE_PER_CYCLE);
